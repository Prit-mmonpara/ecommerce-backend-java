...
public class PaymentController {
    ...
    public ResponseEntity<?> verifyPayment(@RequestBody Map<String, String> payload) {
        logger.info("Verifying payment with payload: {}",  payload);
    ...
    public ResponseEntity<String> sendEmailAfterPayment(@RequestBody Map<String, Object> payload) {
        logger.info("Sending email after payment with payload: {}", payload);
        ...
        if (orderId == null || customerEmail == null || amountObj == null) {
            logger.error("Missing required parameters: orderId, customerEmail or amount");
